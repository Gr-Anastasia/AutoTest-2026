...
def test_addition(a=10,b=5):
    ...
    assert result == 15, f'10 + 5 = 15, а в результате {result}'
...
def test_subtraction(a=10,b=5):
    ...
    assert result == 5, f'10 - 5 = 5, а в результате {result}'
...
def test_multiplication(a=10,b=5):
    ...
    assert result == 50, f'10 * 5 = 50, а в результате {result}'
...
def test_division(a=10,b=0):
    with allure.step("Деление без остатка 10 // 0"):
        ...
        assert result is None, 'При деление на 0, результат = None'
